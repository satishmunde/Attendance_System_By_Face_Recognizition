...
class Register:
    ...
    def sign_up(self):
        if self.var_fname.get() == "Enter Your Name" or self.var_uname.get() == "Username" or self.var_pass.get() == "Password" or self.var_repass.get() == "Confirm Password":
        ...
        #     messagebox.showinfo('Correct'," Valid User Name")  
            ...
            try:
                ...
                my_cursor.execute('''INSERT INTO login(Full_Name,User_Name,Password) values(%s,%s,%s)''',(self.var_fname.get(),
                                                                                                                self.var_uname.get(),
                                                                                                                self.var_pass.get()
